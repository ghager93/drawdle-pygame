...
def normalise_line(line: List[Tuple[int, int]], rect: pg.Rect) -> List[Tuple[float, float]]:
    """
...
def scale_line(line: List[Tuple[float, float]], rect: pg.Rect) -> List[Tuple[float, float]]:
    """
...
def decimate_line(line: List[Tuple[int | float, int | float]], epsilon: float = 1) -> List[Tuple[float, float]]:
    """
...
def calculate_line_bounds(line: List[Tuple[int | float, int | float]]) -> Tuple[float, float, float, float]:
    """
